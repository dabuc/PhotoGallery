...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION="com.heyanbo.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "com.heyanbo.photogallery.PRIVATE";
